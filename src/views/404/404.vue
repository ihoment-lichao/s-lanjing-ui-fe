  ...
  <div class="wave-svg">
    ...
    >
      ...
      <path>
        <animate
          attributeName="d"
          values="M0,50 A50,200 0 0,1 50,50 A50,200 0 0,0 100,50 L100,100 L0,100;M0,60 A50,50 0 0,1 50,50 A50,50 0 0,0 100,50 L100,100 L0,100;M0,50 A50,200 0 0,1 50,50 A50,200 0 0,0 100,50 L100,100 L0,100"
          keyTimes="0; 0.25; 0.25; 0.5; 0.75; 0.75; 1"
          dur="20s"
          repeatCount="indefinite"
          rotate="auto"
        ></animate>
    ...
    <transition name="el-fade-in">
      <div class="content" id="content">
        ...
        <el-button class="back-btn" @click="goHome" v-show="showText && showBtn"
          >返回首页</el-button
        >
      </div>
    </transition>
...
export default {
  ...
  computed: {
    ...
    // 首页地址
    homePath() {
      var hasDashboardRoute = this.asyncRoutes.some((route) => {
        return route.path === "/board/ppc";
      });
      if (hasDashboardRoute) {
        return "/";
      } else {
        return this.asyncRoutes[0].path;
      }
    },
  },
  methods: {
